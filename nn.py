...
class Searchnet:
    ...
    def setupnetwork(self, wordids, urlids):
        ...
        self.wo = [[self.getstrength(hiddenid, urlid, 1) for hiddenid in self.hiddenids] for urlid in self.urlids]
    ...
    def trainquery(self, wordids, urlids, selecteurl):
        self.generatehiddennode(wordids, urlids)

        self.setupnetwork(wordids, urlids)
        self.feedforward()
        targets = [0.0]*len(urlids)
        targets[urlids.index(selecteurl)] = 1.0
